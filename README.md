...
> FirebasePHP is an open-source library (REST API) for PHP run-time that allows you to connect quickly to the Firebase database for data storage. FirebasePHP API allowing you to be updated in realtime as data changes and no additional extensions are required.
